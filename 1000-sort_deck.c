 ...
 *
 * Return: The numerical value of card.
 */
char get_value(deck_node_t *card)
{
 ...
 * @deck:pointer to the head of deck_node_t doubly-linked list.
 */
void insertion_sort_deck_kind(deck_node_t **deck)
{
 ...
 * @deck:points to the head of a deck_node_t doubly-linked list.
 */
void insertion_sort_deck_value(deck_node_t **deck)
{
	deck_node_t *iter, *insert, *tmp;
 ...
 * @deck: pointes to the head of a deck_node_t doubly-linked list.
 */
void sort_deck(deck_node_t **deck)
{
